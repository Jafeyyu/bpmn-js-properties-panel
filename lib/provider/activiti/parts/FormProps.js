...
module.exports = function(group, element, bpmnFactory, translate) {
  ...
  var formKeyList = sessionStorage.getItem("formKeyList");
  var renderSelect = false;
  if(formKeyList) {
    formKeyList = JSON.parse(formKeyList);
    if(Array.isArray(formKeyList)) {
      renderSelect = true;
    }
  }
  if(renderSelect) {
